...
const DEVICE_INIT_SETTINGS_TIMEOUT = 2;
...
class BaseDevice extends Homey.Device {
        ...
        this.homey.setTimeout( async () => 
            {
                try{
                    ...
                    this.log("baseDevice.onInit() error initSettings(): "+error.message);
                }
            },
            DEVICE_INIT_SETTINGS_TIMEOUT * 1000 );
    ...
    async initSettings(){
        try{
            // update device class in settings
