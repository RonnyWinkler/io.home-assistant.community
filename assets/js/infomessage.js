class InfoMessage {
    ...
    _getIcon(type = 'info') {
        const map = {
            info: `<svg class="${this._prefixCls}icon" style="color:#2db7f5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
           <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
         </svg>`,
            success: `<svg class="${this._prefixCls}icon" style="color:#19be6b"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
           <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
         </svg>`,
            warning: `<svg class="${this._prefixCls}icon" style="color:#ff9900" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
           <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
         </svg>`,
            error: `<svg class="${this._prefixCls}icon" style="color:#ed4014" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
           <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clip-rule="evenodd" />
         </svg>`,
            loading: `<svg class="${this._prefixCls}icon" style="color:#2db7f5" xmlns="http://www.w3.org/2000/svg" class="loading" viewBox="0 0 20 20" fill="currentColor">
    ...
    _getMsgHtml(type, content, dangerUseHtml) {
        ...
        messageDOM.innerHTML = `
                <div class="${this._prefixCls}message" >
                    <div>${this._getIcon(type)}</div>
                    <div class="${this._prefixCls}content-text">
					<span class="${this._prefixCls}content-span">${content}</span>
					</div>
                </div>
        `
        return messageDOM
    ...
    _addClosBtn(messageDOM, remove, removeTimer) {
        const svgStr = `<div><svg class="${this._prefixCls}btn" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
if (typeof module !== 'undefined' && typeof module.exports !== 'undefined') {
    module.exports = new InfoMessage();
} else {
    window.$message = new InfoMessage();
}